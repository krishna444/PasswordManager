...
class CI_Email {
	...
	var	$protocol		= "xxxx";	// mail/sendmail/smtp
	var	$smtp_host		= "XXXXX";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "xxxx";		// SMTP Username
	var	$smtp_pass		= "xxxx";		// SMTP Password
	var	$smtp_port		= xxx;		// SMTP Port
